...
9. Download the project from [here] (https://github.com/VishnuGShephertz/Android-Push-Notification-in-PhoneGap-application/archive/master.zip) and import it in the eclipse and add google_play_services as a library project.
...
11.Open PhoneGapActivity.java file in sample app and make following changes.
...
```
	function intializeApp42API() {
			App42.initialize('Your App42 API Key', 'Your App42 Secret Key');
...
__Registering on GCM for PushNotification in Android:__ To get PushNotification we have to register on GCM using Google Project No in PhoneGapActivity.java file.
...
__Customize PushNotification Message:__ You can also customize your PushNotification message by changing following code in App42GCMServivce.java file accordingly.
...
```
4.Add meta-data in application node of AndroidManifest.xml file.
...
```
5.Replace "com.app42.phonegap.push" with your application package name in AndroidManifest.xml file.
